...
#
default: prog2.o tasks_tcp tasks_tcp_HIGHSPEED
...
tasks_tcp_HIGHSPEED: tasks_tcp_HIGHSPEED.o prog2.o
	$(CC) $(CFLAGS) tasks_tcp_HIGHSPEED.o prog2.o -o tasks_tcp_HIGHSPEED
...
tasks_tcp_HIGHSPEED.o:  tasks_tcp_HIGHSPEED.cpp prog2.h
...
#
clean: 
	$(RM) tasks_tcp tasks_tcp_HIGHSPEED *.o *~